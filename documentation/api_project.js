define({
  "name": "Tools Library Gadget ",
  "version": "0.1.0",
  "description": "api based example laravel 5.6 project with token, laracast acl and auth",
  "title": "Tools Library Gadget",
  "url": "http://tlg.local",
  "sampleUrl": "http://tlg.local",
  "header": {
    "title": "Sample project in laravel",
